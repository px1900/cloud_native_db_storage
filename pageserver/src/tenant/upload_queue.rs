...
// XI: The structure of upload_queue is as following:
//  {
//      latest_files: HashMap<LayerFileName, LayerFileMetadata>,
//      latest_metadata: TimelineMetadata,
//      consistent_lsn
//      in_progress_tasks: HashMap<task_counter, UploadTask>
//      queued_tasks: Vec<UploadOps>
//  }
//  The in_progress_tasks are the tasks that have been launched
//  The queued_tasks are the task that haven't been launched, mostly they are waiting previous task
//    to be completed.
//  UploadOps includes:
...
impl UploadQueue {
    ...
    //XI: Initialize an upload_queue with IndexPart.
    //    This will initialize the latest_file, latest_metadata and consistent_lsn
