...
#line 1 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
...
union YYSTYPE
{
#line 85 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
...
#line 137 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                {
					do_start();
...
#line 146 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                {
					do_start();
...
#line 1371 "bootparse.c"
  ...
  case 16: /* $@1: %empty  */
#line 155 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                {
					do_start();
					numattr = 0;
...
#line 1385 "bootparse.c"
  ...
  case 17: /* $@2: %empty  */
#line 165 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                {
					do_end();
				}
...
#line 169 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                {
					TupleDesc tupdesc;
...
#line 1476 "bootparse.c"
  ...
  case 19: /* $@3: %empty  */
#line 251 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                {
					do_start();
...
#line 257 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                {
...
#line 270 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                {
...
#line 322 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                {
					IndexStmt *stmt = makeNode(IndexStmt);
					Oid		relationId;
...
#line 374 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                {
...
#line 386 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                {
					do_start();
					build_indices();
					do_end();
...
#line 395 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                                                { (yyval.list) = lappend((yyvsp[-2].list), (yyvsp[0].ielem)); }
#line 1635 "bootparse.c"
    break;

  case 26: /* boot_index_params: boot_index_param  */
#line 396 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                                                                        { (yyval.list) = list_make1((yyvsp[0].ielem)); }
#line 1641 "bootparse.c"
    break;

  case 27: /* boot_index_param: boot_ident boot_ident  */
#line 401 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                {
...
#line 415 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                        { (yyval.ival) = 1; }
#line 1663 "bootparse.c"
    break;

  case 29: /* optbootstrap: %empty  */
#line 416 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                                { (yyval.ival) = 0; }
#line 1669 "bootparse.c"
    break;

  case 30: /* optsharedrelation: XSHARED_RELATION  */
#line 420 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                                { (yyval.ival) = 1; }
#line 1675 "bootparse.c"
    break;

  case 31: /* optsharedrelation: %empty  */
#line 421 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                                                { (yyval.ival) = 0; }
#line 1681 "bootparse.c"
    break;

  case 32: /* optrowtypeoid: XROWTYPE_OID oidspec  */
#line 425 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                                { (yyval.oidval) = (yyvsp[0].oidval); }
#line 1687 "bootparse.c"
    break;

  case 33: /* optrowtypeoid: %empty  */
#line 426 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                                                        { (yyval.oidval) = InvalidOid; }
#line 1693 "bootparse.c"
    break;

  case 36: /* boot_column_def: boot_ident EQUALS boot_ident boot_column_nullness  */
#line 436 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                {
				   if (++numattr > MAXATTR)
...
#line 444 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                                { (yyval.ival) = BOOTCOL_NULL_FORCE_NOT_NULL; }
#line 1709 "bootparse.c"
    break;

  case 38: /* boot_column_nullness: XFORCE XNULL  */
#line 445 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                                {  (yyval.ival) = BOOTCOL_NULL_FORCE_NULL; }
#line 1715 "bootparse.c"
    break;

  case 39: /* boot_column_nullness: %empty  */
#line 446 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                  { (yyval.ival) = BOOTCOL_NULL_AUTO; }
#line 1721 "bootparse.c"
    break;

  case 40: /* oidspec: boot_ident  */
#line 450 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                                                                        { (yyval.oidval) = atooid((yyvsp[0].str)); }
#line 1727 "bootparse.c"
    break;

  case 44: /* boot_column_val: boot_ident  */
#line 461 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                        { InsertOneValue((yyvsp[0].str), num_columns_read++); }
#line 1733 "bootparse.c"
    break;

  case 45: /* boot_column_val: NULLVAL  */
#line 463 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                        { InsertOneNull(num_columns_read++); }
#line 1739 "bootparse.c"
    break;

  case 46: /* boot_ident: ID  */
#line 467 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = (yyvsp[0].str); }
#line 1745 "bootparse.c"
    break;

  case 47: /* boot_ident: OPEN  */
#line 468 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1751 "bootparse.c"
    break;

  case 48: /* boot_ident: XCLOSE  */
#line 469 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1757 "bootparse.c"
    break;

  case 49: /* boot_ident: XCREATE  */
#line 470 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1763 "bootparse.c"
    break;

  case 50: /* boot_ident: INSERT_TUPLE  */
#line 471 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1769 "bootparse.c"
    break;

  case 51: /* boot_ident: XDECLARE  */
#line 472 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1775 "bootparse.c"
    break;

  case 52: /* boot_ident: INDEX  */
#line 473 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1781 "bootparse.c"
    break;

  case 53: /* boot_ident: ON  */
#line 474 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1787 "bootparse.c"
    break;

  case 54: /* boot_ident: USING  */
#line 475 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1793 "bootparse.c"
    break;

  case 55: /* boot_ident: XBUILD  */
#line 476 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1799 "bootparse.c"
    break;

  case 56: /* boot_ident: INDICES  */
#line 477 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1805 "bootparse.c"
    break;

  case 57: /* boot_ident: UNIQUE  */
#line 478 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1811 "bootparse.c"
    break;

  case 58: /* boot_ident: XTOAST  */
#line 479 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1817 "bootparse.c"
    break;

  case 59: /* boot_ident: OBJ_ID  */
#line 480 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1823 "bootparse.c"
    break;

  case 60: /* boot_ident: XBOOTSTRAP  */
#line 481 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1829 "bootparse.c"
    break;

  case 61: /* boot_ident: XSHARED_RELATION  */
#line 482 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1835 "bootparse.c"
    break;

  case 62: /* boot_ident: XROWTYPE_OID  */
#line 483 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1841 "bootparse.c"
    break;

  case 63: /* boot_ident: XFORCE  */
#line 484 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1847 "bootparse.c"
    break;

  case 64: /* boot_ident: XNOT  */
#line 485 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1853 "bootparse.c"
    break;

  case 65: /* boot_ident: XNULL  */
#line 486 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
...
#line 488 "/Users/rainman/github/test_neon/neon//vendor/postgres-v14/src/backend/bootstrap/bootparse.y"
