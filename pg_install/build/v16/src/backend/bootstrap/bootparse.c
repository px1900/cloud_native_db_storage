...
#line 1 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
...
#line 134 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                {
					do_start();
...
#line 143 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                {
					do_start();
...
#line 1293 "bootparse.c"
  ...
  case 16: /* $@1: %empty  */
#line 152 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                {
					do_start();
					numattr = 0;
...
#line 1307 "bootparse.c"
  ...
  case 17: /* $@2: %empty  */
#line 162 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                {
					do_end();
				}
...
#line 166 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                {
					TupleDesc	tupdesc;
...
#line 1399 "bootparse.c"
  ...
  case 19: /* $@3: %empty  */
#line 249 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                {
					do_start();
...
#line 255 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                {
...
#line 268 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                {
...
#line 321 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                {
					IndexStmt  *stmt = makeNode(IndexStmt);
					Oid			relationId;
...
#line 374 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                {
...
#line 386 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                {
					do_start();
					build_indices();
					do_end();
...
#line 395 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                                                { (yyval.list) = lappend((yyvsp[-2].list), (yyvsp[0].ielem)); }
#line 1560 "bootparse.c"
    break;

  case 26: /* boot_index_params: boot_index_param  */
#line 396 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                                                                        { (yyval.list) = list_make1((yyvsp[0].ielem)); }
#line 1566 "bootparse.c"
    break;

  case 27: /* boot_index_param: boot_ident boot_ident  */
#line 401 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                {
...
#line 416 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                        { (yyval.ival) = 1; }
#line 1589 "bootparse.c"
    break;

  case 29: /* optbootstrap: %empty  */
#line 417 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                                { (yyval.ival) = 0; }
#line 1595 "bootparse.c"
    break;

  case 30: /* optsharedrelation: XSHARED_RELATION  */
#line 421 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                                { (yyval.ival) = 1; }
#line 1601 "bootparse.c"
    break;

  case 31: /* optsharedrelation: %empty  */
#line 422 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                                                { (yyval.ival) = 0; }
#line 1607 "bootparse.c"
    break;

  case 32: /* optrowtypeoid: XROWTYPE_OID oidspec  */
#line 426 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                                { (yyval.oidval) = (yyvsp[0].oidval); }
#line 1613 "bootparse.c"
    break;

  case 33: /* optrowtypeoid: %empty  */
#line 427 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                                                        { (yyval.oidval) = InvalidOid; }
#line 1619 "bootparse.c"
    break;

  case 36: /* boot_column_def: boot_ident EQUALS boot_ident boot_column_nullness  */
#line 437 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                {
				   if (++numattr > MAXATTR)
...
#line 445 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                                { (yyval.ival) = BOOTCOL_NULL_FORCE_NOT_NULL; }
#line 1635 "bootparse.c"
    break;

  case 38: /* boot_column_nullness: XFORCE XNULL  */
#line 446 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                                {  (yyval.ival) = BOOTCOL_NULL_FORCE_NULL; }
#line 1641 "bootparse.c"
    break;

  case 39: /* boot_column_nullness: %empty  */
#line 447 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                  { (yyval.ival) = BOOTCOL_NULL_AUTO; }
#line 1647 "bootparse.c"
    break;

  case 40: /* oidspec: boot_ident  */
#line 451 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                                                                        { (yyval.oidval) = atooid((yyvsp[0].str)); }
#line 1653 "bootparse.c"
    break;

  case 44: /* boot_column_val: boot_ident  */
#line 462 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                        { InsertOneValue((yyvsp[0].str), num_columns_read++); }
#line 1659 "bootparse.c"
    break;

  case 45: /* boot_column_val: NULLVAL  */
#line 464 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                        { InsertOneNull(num_columns_read++); }
#line 1665 "bootparse.c"
    break;

  case 46: /* boot_ident: ID  */
#line 468 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = (yyvsp[0].str); }
#line 1671 "bootparse.c"
    break;

  case 47: /* boot_ident: OPEN  */
#line 469 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1677 "bootparse.c"
    break;

  case 48: /* boot_ident: XCLOSE  */
#line 470 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1683 "bootparse.c"
    break;

  case 49: /* boot_ident: XCREATE  */
#line 471 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1689 "bootparse.c"
    break;

  case 50: /* boot_ident: INSERT_TUPLE  */
#line 472 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1695 "bootparse.c"
    break;

  case 51: /* boot_ident: XDECLARE  */
#line 473 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1701 "bootparse.c"
    break;

  case 52: /* boot_ident: INDEX  */
#line 474 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1707 "bootparse.c"
    break;

  case 53: /* boot_ident: ON  */
#line 475 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1713 "bootparse.c"
    break;

  case 54: /* boot_ident: USING  */
#line 476 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1719 "bootparse.c"
    break;

  case 55: /* boot_ident: XBUILD  */
#line 477 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1725 "bootparse.c"
    break;

  case 56: /* boot_ident: INDICES  */
#line 478 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1731 "bootparse.c"
    break;

  case 57: /* boot_ident: UNIQUE  */
#line 479 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1737 "bootparse.c"
    break;

  case 58: /* boot_ident: XTOAST  */
#line 480 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1743 "bootparse.c"
    break;

  case 59: /* boot_ident: OBJ_ID  */
#line 481 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1749 "bootparse.c"
    break;

  case 60: /* boot_ident: XBOOTSTRAP  */
#line 482 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1755 "bootparse.c"
    break;

  case 61: /* boot_ident: XSHARED_RELATION  */
#line 483 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1761 "bootparse.c"
    break;

  case 62: /* boot_ident: XROWTYPE_OID  */
#line 484 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1767 "bootparse.c"
    break;

  case 63: /* boot_ident: XFORCE  */
#line 485 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1773 "bootparse.c"
    break;

  case 64: /* boot_ident: XNOT  */
#line 486 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1779 "bootparse.c"
    break;

  case 65: /* boot_ident: XNULL  */
#line 487 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
...
#line 489 "/Users/rainman/github/test_neon/neon//vendor/postgres-v16/src/backend/bootstrap/bootparse.y"
