...
#define CONFIGURE_ARGS " 'CFLAGS=-O0 -g3 ' '--enable-debug' '--with-openssl' '--enable-cassert' '--enable-depend' '--with-includes=/usr/local/opt/openssl@3/include' '--with-libraries=/usr/local/opt/openssl@3/lib' 'PKG_CONFIG_PATH=/usr/local/opt/icu4c/lib/pkgconfig' 'INSTALL=/Users/rainman/github/test_neon/neon//scripts/ninstall.sh -C' '--prefix=/Users/rainman/github/test_neon/neon/pg_install/v15'"
...
#define PG_VERSION_STR "PostgreSQL 15.6 on x86_64-apple-darwin23.1.0, compiled by Apple clang version 11.0.3 (clang-1103.0.32.62), 64-bit"
